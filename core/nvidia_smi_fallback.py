            ...
            if line.strip():
                ...
                if len(parts) >= 27:
                    ...
                    gpu_data[gpu_id] = {
                        ...
                        'temperature': float(parts[5]) if parts[5] not in ['N/A', '[N/A]', ''] else None,
                        ...
                        'fan_speed': float(parts[13]) if parts[13] not in ['N/A', '[N/A]', ''] else None,
            ...
            if line.strip():
                ...
                if len(parts) >= 14:
                    ...
                    gpu_data[gpu_id] = {
                        ...
                        'power_default_limit': 0,
                        'fan_speed': float(parts[9]) if parts[9] not in ['N/A', '[N/A]', ''] else None,
